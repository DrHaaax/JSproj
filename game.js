...
function draw() {
    ...
    for (var i = 1; i < 10; i += 1){
        ...
        ctx.fillRect(i * 30 + canvas.width / freqByteData.length, canvas.height - freqByteData[i] * 1.5, canvas.width / freqByteData.length * 30, canvas.height);
        ctx.strokeRect(i * 30 + canvas.width / freqByteData.length, canvas.height - freqByteData[i] * 1.5, canvas.width / freqByteData.length * 30, canvas.height);
